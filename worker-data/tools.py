...
def execute_python_script(file_path: str) -> str:
    """
    Executes a Python script and returns its standard output and standard error.
    Use this to run data correction scripts, API tests, or database migrations.
    Provide the absolute path to the Python file.
    """
    ...
    try:
        ...
        print(f"🐍 [Tool] Executing Python script: {file_path}")
